...
> [!NOTE]
> **Headcode (Terminal Version)** is now released! ⌨️ A pure CLI implementation of Headbrr for terminal power users. Check it out: [chambtai-sys/Headcode](https://github.com/chambtai-sys/Headcode)
